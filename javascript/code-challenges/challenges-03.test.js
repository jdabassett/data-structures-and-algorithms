...
const addTwo = (arr) => {
  // Solution code here...
  let returnArray = arr.map((item)=>(item+2));
  return returnArray;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let returnArray = arr.filter((item)=>(item.includes('and')));
  return returnArray;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let returnArray = arr.filter((item)=>(item%2===1));
  return returnArray;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let returnArray = arr.filter((item)=>(!(forbiddenValues.includes(item))));
  return returnArray;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let returnArray = arr.filter((item)=>(item.baseStat>minBaseStat));
  return returnArray;
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let returnArray = [];
  arr.filter((item)=>((item.baseStat>minBaseStat)?returnArray.push(item.stat.name):null));
  return returnArray;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  // let returnArray = arr.filter((item)=>(!('children' in item)));
  let returnArray = arr.filter((item)=>(!(item.hasOwnProperty('children'))));
  return returnArray;
};
...
For example: evenOddNumericValues(['Greg-or', 2, 4, 1]) returns ['even', 'even', 'odd'].
----------------------------------------------------------------------------------------------- */

const evenOddNumericValues = (arr) => {
  // Solution code here...
  let numberArray = arr.filter((item)=>((typeof item)==='number'));
  let returnArray = numberArray.map((item)=>((item % 2===0)? 'even' : 'odd'));
  return returnArray;
