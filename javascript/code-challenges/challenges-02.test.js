...
// second worthless line
// third worthless line

const raisedToTheThird = (arr) => {
  // Solution code here...
  let returnArray = [];
  arr.forEach((value)=>(returnArray.push(value**3)));
  return returnArray;
};
...
const addOne = (arr) => {
  // Solution code here...
  let returnArray = arr.map((value)=>(value+1));
  return returnArray;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let returnArray = arr.map((value)=>(`${value}?`));
  return returnArray;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let returnArray = [];
  arr.forEach((value)=>(returnArray.push(2**value)));
  return returnArray;
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let returnArray = arr.map((value)=>(2**value));
  return returnArray;
};
...
const charCode = (arr) => {
  // Solution code here...
  let returnArray = arr.map((value)=>(value.charCodeAt(0)));
  return returnArray;
};
...
const evenOdd = (arr) => {
  // Solution code here...
  let returnArray = arr.map((value)=>((value%2===0)?"even":((value%1===0)?"odd":"N/A")));
  return returnArray;
};
...
const extractAbilities = (arr) => {
  // Solution c1ode here...
  let returnArray = arr.map((value)=>(value.ability.name));
  return returnArray;
};
...
const extractStats = (arr) => {
  // Solution code here...
  let returnArray = arr.map((value)=>({name:value.stat.name,total:(value.effort+value.baseStat)}));
  return returnArray;
};
