...
const updateAnimal = (arr, callback) => {
  // Solution code here...
  let returnArray = [];
  arr.forEach((item)=>(returnArray.push(callback(item))));
  return returnArray;
};
...
const alphabetize = (arr) => {
  ...
  return arr.sort((a,b)=>{
    if (startsWithUppercase(a) && !startsWithUppercase(b)){
      return -1;
    } else if (!startsWithUppercase(a) && startsWithUppercase(b)){
      return 1;
    } else {
...
//cite: https://stackoverflow.com/questions/56253008/sorting-a-string-array-with-uppercase-first-including-accents
...
const sortPeople = (arr) => {
  // Solution code here...
  return arr.sort((a,b)=>{return a.lastName.localeCompare(b.lastName);});
};
...
//cite: https://stackoverflow.com/questions/34066752/sort-object-of-weekdays-like-sunday-monday-saturday
