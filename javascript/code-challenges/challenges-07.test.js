...
const sortStarWarsCharacters = (starWarsArr) => {
  // Solution code here...
  let returnArray = starWarsArr.sort((a,b)=>{return b.height - a.height;});
  return returnArray;
};
...
const wordsToCharList = (arr) => {
  // Solution code here...
  let returnArray = [];
  arr.split('').forEach((item)=>{return returnArray.push(item);});
  return returnArray;
};
